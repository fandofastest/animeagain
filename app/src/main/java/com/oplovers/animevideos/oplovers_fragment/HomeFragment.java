package com.oplovers.animevideos.oplovers_fragment;
...
import com.oplovers.animevideos.DetailsActivity;
import com.oplovers.animevideos.ItemMovieActivity;
import com.oplovers.animevideos.ItemTVActivity;
import com.oplovers.animevideos.MainActivity;
import com.oplovers.animevideos.R;
import com.oplovers.animevideos.oplovers_adapter.GenreAdapter;
import com.oplovers.animevideos.oplovers_adapter.GenreHomeAdapter;
import com.oplovers.animevideos.oplovers_adapter.HomePageAdapter;
import com.oplovers.animevideos.oplovers_adapter.LiveTvHomeAdapter;
import com.oplovers.animevideos.oplovers_model.CommonModels;
import com.oplovers.animevideos.oplovers_model.GenreModel;
import com.oplovers.animevideos.oplovers_utl.ApiResources;
import com.oplovers.animevideos.oplovers_utl.BannerAds;
import com.oplovers.animevideos.oplovers_utl.Constants;
import com.oplovers.animevideos.oplovers_utl.NetworkInst;
...
import com.oplovers.animevideos.Config;
...
public class HomeFragment extends Fragment {
    ...
    private RecyclerView recyclerViewMovie, recyclerViewTv, recyclerViewlatestTvSeries, recyclerViewGenre,recyclerViewPopular,rvlatestmoviews,rvpopularmovies;
    ...
    private HomePageAdapter adapterMovie, adapterlatestSeries,adapterpopular,adapterlatestmovies;
    private LiveTvHomeAdapter adapterTv;
    private List<CommonModels> listlatestMovie = new ArrayList<>();
    private List<CommonModels> listlatestSeries = new ArrayList<>();
    ...
    private Button btnMoreMovie, btnMoreTv, btnMorelatestSeries,btnMorePopularTvseries,btnmorepopularmovies,btnmorelatestmovies;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnMorelatestSeries=view.findViewById(R.id.btn_more_series);
        ...
        //----featured tv recycler view-----------------
        recyclerViewlatestTvSeries = view.findViewById(R.id.recyclerViewlatestseries);
        recyclerViewlatestTvSeries.setLayoutManager(new LinearLayoutManager(activity, LinearLayoutManager.HORIZONTAL, false));
        recyclerViewlatestTvSeries.setHasFixedSize(true);
        recyclerViewlatestTvSeries.setNestedScrollingEnabled(false);
        adapterlatestSeries = new HomePageAdapter(getContext(), listlatestSeries);
        recyclerViewlatestTvSeries.setAdapter(adapterlatestSeries);
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0; i < response.length(); i++) {
                    ...
                    try {
                        ...
                        models.setId(jsonObject.getString("videos_id"));
                        listlatestSeries.add(models);

                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                }
                adapterlatestSeries.notifyDataSetChanged();
